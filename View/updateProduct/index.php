...
<head>
    ...
    <title>Update Product - Thriftin</title>
    <!-- ^ library import -->
    ...
    <!-- ^ local style -->
    <link rel="stylesheet" href="view/updateProduct/styles.css">
...
<body>
    ...
    <div class="update-container">
        ...
        <div class="image-preview">
            <img src="<?= $item['image'] ?? 'public/assets/default-product.jpg' ?>" alt="Product Image Preview" id="imagePreview">
        ...
        <form method="POST" class="product-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="fabric_type" name="fabric_type" value="<?= htmlspecialchars($product['fabric_type'] ?? '') ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" step="0.01" min="0" value="<?= $product['price'] ?? 0 ?>" required>
            </div>

            <div class="form-actions">
                <button type="submit" class="btn primary">Update Product</button>
                <a href="?c=profile&m=sales" class="btn secondary">Cancel</a>
            </div>
        </form>
    </div>
